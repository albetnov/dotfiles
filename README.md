...
> This version is similar to [Hyprland Branch](https://github.com/albetnov/dotfiles/tree/hyprland).

## Setup

Follow the setup from [Hyprland Branch](https://github.com/albetnov/dotfiles/tree/hyprland).
...
- `immediate = 1` to `steam` & `gamescope`
- new `.config/hypr/scripts/game-mode.sh` for flawless gaming session (without disruption, disabled DND).
